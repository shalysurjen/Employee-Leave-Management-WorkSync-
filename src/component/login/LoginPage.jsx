...
const LoginPage = ({ onLogin }) => {
  const [email, setEmail] = useState("employee@company.com"); // Default to employee email
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      // Logic: Only admin@company.com gets HR Admin, everyone else is Employee
      const role = email === "admin@company.com" ? "HR Admin" : "Employee";
      onLogin(role);
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen flex bg-[#F8FAFC] font-sans antialiased">
      {/* LEFT SIDE: Corporate Branding & Quote */}
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            ...
            <div className="relative pt-8 border-t border-white/10">
              ...
              <p className="mt-4 text-slate-500 font-bold uppercase tracking-widest text-xs">— Corporate Wellness Initiative</p>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16">
        ...
        >
          ...
          <div className="mb-12 lg:hidden flex items-center gap-3">
            ...
            <span className="text-xl font-black text-slate-900 tracking-tighter">LEAVE MANAGEMENT</span>
          </div>

          <header className="mb-10">
            <h3 className="text-4xl font-black text-slate-900 tracking-tight mb-2">Sign In</h3>
            <p className="text-slate-500 font-medium">Please enter your company email to access your dashboard.</p>
          </header>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4.5 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-50 focus:border-indigo-600 transition-all font-bold text-slate-700 shadow-sm"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button type="button" className="text-[10px] font-black uppercase tracking-widest text-indigo-600 hover:text-indigo-700">Reset Access</button>
              </div>
              <div className="relative group">
          ...
          <footer className="mt-12 pt-8 border-t border-slate-100">
            <div className="flex items-center justify-between text-xs font-bold">
              <span className="text-slate-400 uppercase tracking-widest">IT Support: ext 404</span>
              <a href="#" className="text-slate-900 hover:text-indigo-600">Privacy Policy</a>
            </div>
          </footer>
        </motion.div>
      </div>
